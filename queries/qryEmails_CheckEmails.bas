Operation =1
Option =0
Where ="(((qry_tblStates_Email.ToEmailAddress) Is Null) AND ((qry_tblStates.FileName) Is"
    " Not Null)) OR (((qry_tblStates_Email.ToEmailAddress) Is Null) AND ((qry_tblStat"
    "es.FileName_Claborn) Is Not Null))"
Begin InputTables
